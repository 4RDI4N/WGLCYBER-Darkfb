...
def tik():
    titik = [
     '.   ', '..  ', '... ']
    for o in titik:
        print '\r\x1b[1;91m[\xe2\x97\x8f] \x1b[1;92mNgopi dulu Boyy \x1b[1;97m' + o,
        sys.stdout.flush()
        time.sleep(1)
...
def login():
    ...
    try:
        ...
        try:
            ...
            print '\n\x1b[1;91m[!] beli kuota dulu woyy'
            keluar()
        ...
        if 'checkpoint' in url:
            print '\n\x1b[1;91m[!] \x1b[1;93mAkun Checkpoint Woyy'
...
def menu():
    ...
    try:
        ...
        try:
            ...
            os.system('clear')
            print '\x1b[1;91m[!] \x1b[1;93makun lo kena Checkpoint Woyy'
            os.system('rm -rf login.txt')
            time.sleep(1)
            login()
        except requests.exceptions.ConnectionError:
